...
+ 不是专业前端，所以只有1920*1080 分辨率可以正常显示，整体做的很烂...，前端代码在库里，[毕业设计前端代码(基于VUe+Element的人事管理系统)](https://github.com/xuezixiangS/HROS-UI)，
+ 陆续有小伙伴找我要毕业论文参考，所以抽时间整理下：
+ 论文+ PPT+ 答辩稿 + 项目部署包+ 数据库sql(需要建库vhr) 在论文文件夹
+ 如果想部署的小伙伴可以直接部署，只需要jdk，mysql环境就可以
+ CSDN :[https://xuezixiang.blog.csdn.net/](https://xuezixiang.blog.csdn.net/)
+ 个人博客：[https://xuezixiangs.github.io/](https://xuezixiangs.github.io/)
