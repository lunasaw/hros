...
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employeeSalary2Excel(List<Employee> list) {
        //1. 创建一个 Excel 文档
        ...
        //文档管理员
        docInfo.setManager("xuezixiang");
        //设置公司信息
        docInfo.setCompany("xuezixiang.com");
        //4. 获取文档摘要信息
        SummaryInformation summInfo = workbook.getSummaryInformation();
        //文档标题
        summInfo.setTitle("员工工资信息表");
        //文档作者
